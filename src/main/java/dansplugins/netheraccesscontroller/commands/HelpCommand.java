...
public class HelpCommand {
    ...
    public boolean execute(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.AQUA + "/nac allow <ign> - Allow a player to access the nether.");
        sender.sendMessage(ChatColor.AQUA + "/nac deny <ign> - Disallow a player from accessing the nether.");
        sender.sendMessage(ChatColor.AQUA + "/nac config <show | set> - View or set config options.");
        return true;
    }
